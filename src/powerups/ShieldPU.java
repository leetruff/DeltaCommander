 ...
 * Der Spieler erhaelt beim aufsammeln ein Schild, das ihn vor Schaden durch Gegner schuetzt.
 * 
 * @author Tim
 */
public class ShieldPU extends Sprite implements PickUp {
	...
	static Texture defaultTexture = new Texture(Gdx.files.internal("sprites/shieldPU.png"));
    
	boolean collected;
    
	/**
     * Konstruktor fuer die Erstellung eines Shield-PowerUp Objekts
     * 
     ...
     */
	public ShieldPU(World world, float xPos, float yPos){
