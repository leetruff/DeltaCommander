 ...
 * Der Spieler erhaelt beim aufsammeln eine modifizierte Waffe, welche 3 Schuesse gleichzeitig abfeuert.
 * 
 * @author Lars
 */
public class TripleshotPU extends Sprite implements PickUp{
	...
	static Texture defaultTexture = new Texture(Gdx.files.internal("sprites/tripleshotPU.png"));
    
    boolean collected;
    
    /**
     * Konstruktor fuer die Erstellung eines Tripleshot-PowerUp Objekts
     * 
     ...
     */
	public TripleshotPU(World world, float xPos, float yPos){
	...
	public void defineBody(float xPos, float yPos) {
		...
		b2body.createFixture(fdef).setUserData("triple");
	}
