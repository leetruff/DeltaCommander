 ...
 * Der Spieler erhaelt beim aufsammeln ein zusaetzliches Leben.
 * 
 * @author Tim
 */
public class LifePU extends Sprite implements PickUp {
	...
	static Texture defaultTexture = new Texture(Gdx.files.internal("sprites/lifePU.png"));
  
    boolean collected;
	
    /**
     * Konstruktor fuer die Erstellung eines Life-PowerUp Objekts
     * 
     ...
     */
	public LifePU(World world, float xPos, float yPos){
	...
	public void defineBody(float xPos, float yPos) {
		...
		b2body.createFixture(fdef).setUserData("life");
	}
