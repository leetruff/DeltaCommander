 ...
 * Der Spieler erhaelt beim aufsammeln eine modifizierte Waffe, welche Laserschuesse abfeuert.
 * 
 * @author Lars
 */
public class LaserPU extends Sprite implements PickUp{
	...
	static Texture defaultTexture = new Texture(Gdx.files.internal("sprites/laserPU.png"));
    
    boolean collected;
    
    /**
     * Konstruktor fuer die Erstellung eines Laser-PowerUp Objekts
     * 
     ...
     */
	public LaserPU(World world, float xPos, float yPos){
	...
	public void defineBody(float xPos, float yPos) {
		...
		b2body.createFixture(fdef).setUserData("laser");
	}
