 ...
 */
public class LevelIce1Multi extends LevelIce1 {
    ...
    public LevelIce1Multi(MyGdxGame game, Server server, Connection con) {
        super(game);
        this.server = server;
        connection = con;
        isServer = true;
    ...
    public LevelIce1Multi(MyGdxGame game, Client client) {
        super(game);
        this.client = client;
        isServer = false;
    ...
    public void render(float delta)
    {
        ...
        if(restart)
        {
            ...
            super.game.setScreen(new LevelIce1Multi(super.game,client));
        }
    ...
    public void stageCompleted(){
        ...
        if(isServer) {
            game.setScreen(new LevelIce2Multi(game, hero.getHealth(), hero.getLives(), hero.getAmmo(), hero.getScore(), hero.getLaserAmmo(), hero.getTripleAmmo(),server,connection));
        }
        else
        {
            game.setScreen(new LevelIce2Multi(game, hero.getHealth(), hero.getLives(), hero.getAmmo(), hero.getScore(), hero.getLaserAmmo(), hero.getTripleAmmo(),client));
    ...
    public void restart()
    {
        if(isServer)
        {
            ...
            super.game.setScreen(new LevelIce1Multi(super.game,server,connection));
        }
