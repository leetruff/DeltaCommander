...
import com.mygdx.game.LevelScifi3.B2WorldCreatorCustom;
...
/**
 * Screen: Level 2 der SciFi Welt
 * @Leveldesign Tim
 * @author Fabian, Lars, Hermann, Tim
 */
public class LevelScifi2 extends GameScreen {

	//Zeit die zu unterbieten ist in Sekunden:
	final int timeToBeat = 98;
	 ...
	 */
	public LevelScifi2(MyGdxGame game, int health, int lives, int ammo, int score, int laserAmmo, int tripleAmmo){
		this(game);
	...
	public void show() {
		...
		map = maploader.load("level/scifiLevel2.tmx");
	   ...
	   pauseMenu.saveButton.addListener(new ChangeListener() {
	       ...
	       public void changed(ChangeEvent event, Actor actor) {
			   game.playButtonClicked();
				XMLInteraction.saveGame(hero, "levelscifi2");
	       }});
	   pauseMenu.menuButton.addListener(new ChangeListener() {
		...
		enemyTowerList.add(new EnemyTower(world,hero,2111+25,1025+15,false,game));
		enemyTowerList.add(new EnemyTower(world,hero,6280+25,1089+15,false,game));
		enemyTowerList.add(new EnemyTower(world,hero,6662+25,1089+15,false,game));	
		enemyTowerList.add(new EnemyTower(world,hero,7685+25,705+15,false,game));

		enemySoldierList = new ArrayList<EnemySoldier>();
		enemySoldierList.add(new EnemySoldier(world,hero,this,150,770,game));
		enemySoldierList.add(new EnemySoldier(world,hero,this,2178,667,game));
		enemySoldierList.add(new EnemySoldier(world,hero,this,2691+20,515,game));
		enemySoldierList.add(new EnemySoldier(world,hero,this,3374,536,game));
		enemySoldierList.add(new EnemySoldier(world,hero,this,6470,962,game));
		enemySoldierList.add(new EnemySoldier(world,hero,this,7493,834,game));
		enemySoldierList.add(new EnemySoldier(world,hero,this,7493,578,game));


		enemyHomingList = new ArrayList<EnemyHoming>();	
		enemyHomingList.add(new EnemyHoming(world, hero, 60f * MyGdxGame.PPM, 4.8f * MyGdxGame.PPM, game));
		...
		healthPU1 = new HealthPU(world, 1584+14, 960+14);
		powerUpList.add(healthPU1);
		healthPU2 = new HealthPU(world, 3900+14+20, 514+14);
		powerUpList.add(healthPU2);
		healthPU3 = new HealthPU(world, 7875+14, 578+14);
		powerUpList.add(healthPU3);
		healthPU4 = new HealthPU(world, 5310+14, 386+14);
		powerUpList.add(healthPU4);
		shieldPU1 = new ShieldPU(world, 5955+14+15, 833+14);
		powerUpList.add(shieldPU1);
		lifePU1 = new LifePU(world, 6918+14+15, 384+14);
		powerUpList.add(lifePU1);
		triplePU1 = new TripleshotPU(world, 7050+14, 897+14);
		powerUpList.add(triplePU1);
			...
			if (Application.ApplicationType.Desktop == Gdx.app.getType()) {
				...
				if (!paused) {
					...
					if (Gdx.input.isKeyJustPressed(Input.Keys.ENTER)) {
						System.out.println("X: " + hero.b2body.getPosition().x*150 + " Y: " + hero.b2body.getPosition().y*150+" \n"+"X: " + hero.b2body.getPosition().x + " Y: " + hero.b2body.getPosition().y);
					}
					if (Gdx.input.isKeyJustPressed(Input.Keys.T)) {
							hero.b2body.setTransform(66.52f,9.55f,0);
					}
				}
	...
	public void initCheckpoints()
	{
		...
		checkpoints[0]= new Checkpoint(1.1f, 1.29f-0.01f);
		checkpoints[1]= new Checkpoint(14.55f, 3.85f-0.01f);
		checkpoints[2]= new Checkpoint(35.87f,2.57f-0.01f);
		checkpoints[3]= new Checkpoint(52.11f,3.85f-0.01f);
		checkpoints[4]= new Checkpoint(64.05f,6.84f-0.01f);	
	...
	public void stageCompleted(){
		...
		game.setScreen(new LevelScifi3(game, hero.getHealth(), hero.getLives(), hero.getAmmo(), hero.getScore(), hero.getLaserAmmo(), hero.getTripleAmmo()));
	}
	/**
	...
	public void restart()
	{
		game.setScreen(new LevelScifi2(game));
	}
