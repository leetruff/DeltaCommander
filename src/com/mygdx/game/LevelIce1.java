...
/**
 * Screen: Level 1 der Antarctica Welt
 * @Leveldesign Hermann
 * @author Fabian, Lars, Hermann, Tim
 */
public class LevelIce1 extends GameScreen {

	//Zeit die zu unterbieten ist in Sekunden:
	final int timeToBeat = 63;
	 ...
	 */
	public LevelIce1(MyGdxGame game, int health, int lives, int ammo, int score, int laserAmmo, int tripleAmmo){
		this(game);
	...
	public void show() {
		...
		map = maploader.load("level/iceLevel1.tmx");
		...
		healthPU1 = new HealthPU(world, 1658, 700);
		powerUpList.add(healthPU1);
		shieldPU1 = new ShieldPU(world, 5545, 675);
		powerUpList.add(shieldPU1);
		lifePU1 = new LifePU(world, 2903, 450);
	   ...
	   pauseMenu.menuButton.addListener(new ChangeListener() {
		...
		enemyTowerList.add(new EnemyTower(world,hero,4848,143,false,game));
		enemyTowerList.add(new EnemyTower(world,hero,6390,529,false,game));
		enemyTowerList.add(new EnemyTower(world,hero,6726,529,false,game));


		enemySoldierList = new ArrayList<EnemySoldier>();
		enemySoldierList.add(new EnemySoldier(world,hero,this,1156,397,game));
		enemySoldierList.add(new EnemySoldier(world,hero,this,2381,526,game));
		enemySoldierList.add(new EnemySoldier(world,hero,this,4672,409,game));
		enemySoldierList.add(new EnemySoldier(world,hero,this,5626,409,game));
		enemySoldierList.add(new EnemySoldier(world,hero,this,8383,280,game));
	...
	public void initCheckpoints()
	{
		...
		checkpoints[1]= new Checkpoint(23.44f,1f-hero.getHeight()/2);
		checkpoints[2]= new Checkpoint(39.38f,3.6f-hero.getHeight()/2);
		checkpoints[3]= new Checkpoint(58.5f,1.87f-hero.getHeight()/2);
	...
	public void stageCompleted(){
		...
		XMLInteraction.saveScore("levelice1", game.getUsername(), hero.getScore());
		hero.updateSavedScore();
		game.setScreen(new LevelIce2(game, hero.getHealth(), hero.getLives(), hero.getAmmo(), hero.getScore(), hero.getLaserAmmo(), hero.getTripleAmmo()));
	}
	/**
	...
	public void restart()
	{
		game.setScreen(new LevelIce1(game));
	}
