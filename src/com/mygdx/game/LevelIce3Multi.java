 ...
 */
public class LevelIce3Multi extends LevelIce3
{
    ...
    public LevelIce3Multi(MyGdxGame game, int health, int lives, int ammo, int score, int laserAmmo, int tripleAmmo, Server server, Connection con){
        super(game,health,lives,ammo,score,laserAmmo,tripleAmmo);
        this.server = server;
        connection = con;
        isServer = true;
    }
    public LevelIce3Multi(MyGdxGame game, int health, int lives, int ammo, int score, int laserAmmo, int tripleAmmo, Client client){
        super(game,health,lives,ammo,score,laserAmmo,tripleAmmo);
        this.client=client;
        isServer=false;
    }
    public LevelIce3Multi(MyGdxGame game, Server server, Connection con) {
        super(game);
        this.server = server;
        connection = con;
        isServer = true;
    ...
    public LevelIce3Multi(MyGdxGame game, Client client) {
        super(game);
        this.client = client;
        isServer = false;
    ...
    public void render(float delta)
    {
        ...
        if(restart)
        {
            ...
            super.game.setScreen(new LevelIce3Multi(super.game,client));
        }
    ...
    public void restart()
    {
        if(isServer)
        {
            ...
            super.game.setScreen(new LevelIce3Multi(super.game,server,connection));
        }
